...
1. **`plugins/flow-next/docs/flowctl.md`** — Add new commands:
   ...
   - `codex completion-review <fn-N>` command (in codex section ~549)
...
2. **`plugins/flow-next/docs/ralph.md`** — Add completion review gate:
   ...
   - Configuration variables: `COMPLETION_REVIEW`, `REQUIRE_COMPLETION_REVIEW`
...
- Env vars: `COMPLETION_REVIEW`, `REQUIRE_COMPLETION_REVIEW`
...
- [ ] ralph.md configuration reference includes `COMPLETION_REVIEW`, `REQUIRE_COMPLETION_REVIEW`
